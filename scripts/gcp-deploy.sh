...
gcloud run deploy "$SERVICE" \
  ...
  --timeout 300 \
  --set-env-vars "^|^NEXT_PUBLIC_SITE_URL=$SITE_URL|NEXT_PUBLIC_DEPLOY_CHANNEL=$CHANNEL|POLYVISE_APP_CHANNEL=$CHANNEL|POLYVISE_REPOSITORY=${POLYVISE_REPOSITORY:-firestore}|FIRESTORE_PROJECT_ID=${FIRESTORE_PROJECT_ID:-$PROJECT_ID}|POLYVISE_ENABLE_MOCK_LLM=${POLYVISE_ENABLE_MOCK_LLM:-false}|POLYVISE_EVIDENCE_PROVIDER=${POLYVISE_EVIDENCE_PROVIDER:-tavily}|POLYVISE_QUICK_MODEL=${POLYVISE_QUICK_MODEL:-openai/gpt-4o-mini}|POLYVISE_DEEP_MODEL=${POLYVISE_DEEP_MODEL:-openai/gpt-4.1}|POLYVISE_YES_MODEL=${POLYVISE_YES_MODEL:-${POLYVISE_QUICK_MODEL:-openai/gpt-4o-mini}}|POLYVISE_NO_MODEL=${POLYVISE_NO_MODEL:-${POLYVISE_QUICK_MODEL:-openai/gpt-4o-mini}}|POLYVISE_OPENING_MODEL=${POLYVISE_OPENING_MODEL:-openai/gpt-4o-mini}|POLYVISE_CROSS_EXAMINATION_MODEL=${POLYVISE_CROSS_EXAMINATION_MODEL:-openai/gpt-4o-mini}|POLYVISE_REBUTTAL_MODEL=${POLYVISE_REBUTTAL_MODEL:-openai/gpt-4.1}|POLYVISE_CLOSING_MODEL=${POLYVISE_CLOSING_MODEL:-openai/gpt-4.1}|POLYVISE_JUDGE_MODEL=${POLYVISE_JUDGE_MODEL:-openai/gpt-4.1}|POLYVISE_LLM_TIMEOUT_MS=${POLYVISE_LLM_TIMEOUT_MS:-45000}|POLYVISE_LLM_MAX_TOKENS=${POLYVISE_LLM_MAX_TOKENS:-2200}" \
